...
const Display = ({contract, account}) => {
    ...
    const getdata = async () => {
        ...
        if(!isEmpty){
            const str = dataArray.toString();   //yahan links aa gaye hai images ke 
            const str_array = str.split(",");  // yahan linkes ko array ke form mai store kar liye hai
            // console.log(str);
            // console.log(str_array);

            //links ko use karke images ko display karenge
